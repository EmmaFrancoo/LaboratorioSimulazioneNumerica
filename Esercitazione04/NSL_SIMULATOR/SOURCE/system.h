...
private:
  ...
  Random _rnd;          // Random number generator (così non devo passarlo ad ogni funzione)
  field <Particle> _particle; // Field of particle objects representing the system (OGGETTO DI TIPO FIELD)

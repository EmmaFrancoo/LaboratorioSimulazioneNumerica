...
double Random :: CL (double x_0, double gamma){
// This function generates a random number from a Cauchy-Lorentz distribution with given x_0 and gamma
   double u=Rannyu();
   double pi = M_PI;
   return x_0 + gamma*tan(pi*(u-0.5));
}
